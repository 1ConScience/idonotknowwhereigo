...
def nettoyage():
    ...
    pygame.sprite.Group.empty(blocks_horizontal_col)
    pygame.sprite.Group.empty(blocks_vertical_col)
...
blocks_horizontal_col = pygame.sprite.Group()
blocks_vertical_col = pygame.sprite.Group()